...
var _request = _interopRequireDefault(__webpack_require__(/*! ../lib/request.js */ 19));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function getDate() {
  return _request.default.get('/repository/get?id=294340&token=YuTYLOHzVbLJTaFRCMFPKO8MHbg-XbgP');
}
...
var _config = __webpack_require__(/*! ../common/config */ 20);
...
function baseRequest(options) {
  ...
  return new Promise(function (resolve, reject) {
    var baseUrl = _config.config.base_url + setUrlconfig(url);
    uni.showLoading({
      title: '加载中',
      mask: true
    });
    ...
    var errMsg = "failed: ".concat(url, " ").concat(method, " ").concat(e.status, " ").concat(e.message, " ").concat(e.statusCode);
    console.error('error #%d', errMsg);
  });
}

var request = ["post", "put", "get", "delete", "options"].reduce(function (request, method) {
